...
const corruptionDialog = [
  { 
    ...
    choices: [
      { text: '1. Всё в порядке, я справляюсь.', next: 1, scoreChange: 1 }, // Никаких изменений
      { text: '2. Мне нужно больше времени, чтобы всё завершить.', next: 2, scoreChange: 0 }, // Никаких изменений
      { text: '3. Я боюсь, что не успею... Нужно что-то предпринять.', next: 3, scoreChange: 0 }, // Никаких изменений
    ] 
  },
  { 
    npc: 'Professor', 
    ...
    choices: [
      { text: '1. Я предпочитаю не торопиться, результат важнее.', next: 4, scoreChange: 1 }, // Никаких изменений
      { text: '2. Что вы предлагаете? Как быстрее закончить?', next: 5, scoreChange: 0 }, // Никаких изменений
      { text: '3. Я не уверен, что готов на такие компромиссы.', next: 6, scoreChange: 1 }, // Никаких изменений
    ] 
  },
  { 
    npc: 'Professor', 
    ...
    choices: [
      { text: '1. Я думаю, да. Сколько это будет стоить?', next: 7, scoreChange: 0 }, // Никаких изменений
      { text: '2. Думаю, я справлюсь без помощи.', next: 8, scoreChange: 1 }, // Никаких изменений
      { text: '3. Мне нужно подумать, но времени мало...', next: 9, scoreChange: 0 }, // Никаких изменений
    ] 
  },
  { 
    npc: 'Professor', 
    ...
    choices: [
      { text: '1. Согласен, но это не кажется правильным.', next: 10, scoreChange: 0 }, // Никаких изменений
      { text: '2. Хорошо, давайте попробуем это.', next: 11, scoreChange: 0 }, // Согласие на коррупцию
      { text: '3. Я по-прежнему сомневаюсь.', next: 12, scoreChange: 1 }, // Никаких изменений
    ] 
  },
  { 
    npc: 'Professor', 
    ...
    choices: [
      { text: '1. Я верю вам, но мне нужно больше времени для размышлений.', next: 13, scoreChange: 0 }, // Никаких изменений
      { text: '2. Возможно, вы правы. Я попробую.', next: 14, scoreChange: 0 }, // Согласие на коррупцию
      { text: '3. Я не готов соглашаться.', next: 15, scoreChange: 1 }, // Никаких изменений
    ] 
  },
  { 
    npc: 'Professor', 
    ...
    choices: [
      { text: '1. Я не хочу провала. Я сделаю всё, что нужно.', next: 18, scoreChange: 0 }, // Никаких изменений
      { text: '2. Возможно, я не готов рисковать своей репутацией.', next: 19, scoreChange: 1 }, // Никаких изменений
    ] 
  },
  { npc: 'Professor', 
    ...
    choices: [
      { text: '1. Хорошо, давайте продолжим, я готов к этому.', next: 20, scoreChange: 0 }, // Согласие на помощь
      { text: '2. Я всё ещё не уверен, что это правильный выбор.', next: 21, scoreChange: 1 }, // Никаких изменений
    ] 
  },
  { 
    npc: 'Professor', 
    ...
    choices: [
      { text: '1. Спасибо, профессор. Я благодарен за помощь.', next: 22, scoreChange: 0 }, // Согласие на помощь
      { text: '2. Я не знаю, профессор, всё слишком сложно.', next: 23, scoreChange: 1 }, // Никаких изменений
    ] 
  },
  { 
    npc: 'Professor', 
    ...
    choices: [
      { text: '1. Хорошо, давайте продолжим.', next: 24, scoreChange: 0 }, // Согласие на продолжение
      { text: '2. Я сомневаюсь в этом, но сделаю, что нужно.', next: 25, scoreChange: 1 }, // Никаких изменений
    ] 
  },
  { 
    npc: 'Professor', 
    ...
    choices: [
      { text: '1. Я знаю. Спасибо, что помогаете.', next: 26, scoreChange: 0 }, // Согласие на помощь
      { text: '2. Мне нужно подумать ещё немного.', next: 27, scoreChange: 1 }, // Никаких изменений
    ] 
  },
  { 
    npc: 'Professor', 
    ...
    choices: [
      { text: '1. Спасибо за предложение. Я продолжу работать.', next: 28, scoreChange: 0 }, // Согласие на помощь
      { text: '2. Нет, я должен сделать это сам.', next: 29, scoreChange: 1 }, // Никаких изменений
    ] 
  }
];
